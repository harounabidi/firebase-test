...
export default function FeedbackSheet({ menuOpen, setMenuOpen }) {
  ...
  return (
    <>
      ...
      >
        <div className="mt-14 w-full overflow-y-auto px-4 pb-6">
          ...
          <p className="my-4 text-sm text-stone-600">
            When you leave feedback, we might reach out to discuss your
            thoughts. If you don&apos;t want to be contacted, please mention
            this in your feedback. (Optional)
          </p>
